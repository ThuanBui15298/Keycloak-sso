...
<html>
<head>
    <title>Welcome to VietNamPost</title>
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
            <div class="welcome-header">
                <img src="${resourcesPath}/logo-vietnam.png" alt="${productName}" border="0"/>
                <h1>Xin chào <strong>VietNamPost</strong></h1>
            </div>
            <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="card-pf h-l">
                            ...
                            <#elseif bootstrap>
                                ...
                                <#else>
                                    <p class="welcome-message">
                                        <img src="welcome-content/alert.png">You need local access to create the initial
                                        admin user. <br><br>Open <a href="${localAdminUrl}">${localAdminUrl}</a>
                            ...
                            <div class="welcome-primary-link">
                                <h3><a href="${adminUrl}"><img src="welcome-content/user.png">Đăng nhập <i
                                                class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
                                <div class="description">
                                    VietNamPost quản lý tập trung, bật lên kết nối
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <#--        </div>-->
                <div class="col-xs-12 col-sm-4">
                        <img src="welcome-content/hinhanh.jpg" style="height: 371px; width: 500px">
