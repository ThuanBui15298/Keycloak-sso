...
public class MigrateTo1_9_0 implements Migration {
    ...
    public void migrate(KeycloakSession session) {
        ...
        if (realm != null && realm.getDisplayNameHtml() != null && realm.getDisplayNameHtml().equals("<strong>VNPOST</strong>")) {
            realm.setDisplayNameHtml("<div class=\"kc-logo-text\"><span>VNPOST</span></div>");
        }
    }
